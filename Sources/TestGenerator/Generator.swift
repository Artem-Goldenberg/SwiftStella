...
@main struct Run {
    ...
    static func parseFile(at relativePath: String) throws {
        ...
        fm.createFile(atPath: "printed-trees/\(relativePath).txt", contents: treeText)
    }

    static func main() throws {

        guard fm.changeCurrentDirectoryPath("Tests/StellaTests/Resources") else {
            fatalError("Failed to go to the resource directory")
        }
